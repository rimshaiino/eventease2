            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-4 mx-auto">
                        ...
                        @endif
                        <div class="">
                            <button onclick="location.href='{{ route('events.past') }}'" class="flex mb-4 ml-auto text-white bg-purple-400 border-0 py-2 px-6 focus:outline-none hover:bg-purple-500 rounded">過去のイベント</button>
                            <button onclick="location.href='{{ route('events.create') }}'" class="flex mb-4 ml-auto text-white bg-purple-400 border-0 py-2 px-6 focus:outline-none hover:bg-purple-500 rounded">新規登録</button>
                        </div>
                        <div class="w-full mx-auto overflow-auto">
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="px-4 py-3 text-purple-400"><a href="{{ route('events.show', ['event' => $event->id]) }}">{{ $event->name }}</a></td>
